...
Within this folder, the "1-RawData" folder contains the essential raw datafiles obtained from the z-Tree and otree session files (see #2). The "Data" folder contains the processed datasets (in .dta format) made suitable for analysis.
...
Note that all variables in the processed STATA datasets are labelled in a way that are self-explanatory.
